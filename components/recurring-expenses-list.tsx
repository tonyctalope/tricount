...
import { RecurringExpense, User } from "@prisma/client"
...
type RecurringExpenseWithPayer = Omit<RecurringExpense, "amount"> & {
  amount: number
  payer: User
}

export function RecurringExpensesList({ expenses }: { expenses: RecurringExpenseWithPayer[] }) {
    ...
    return (
      <Card>
        <CardContent className="py-8 text-center text-muted-foreground">
          Aucune dépense récurrente. Ajoutez-en une pour gagner du temps chaque mois !
        </CardContent>
      </Card>
    )
  }
                ...
                <div className="flex flex-col items-end gap-2 shrink-0">
                  ...
                  <div className="flex gap-1">
                    <Button asChild variant="ghost" size="icon" className="h-8 w-8">
                      <Link href={`/recurring/${expense.id}/edit`} aria-label="Modifier">
